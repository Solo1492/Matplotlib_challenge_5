...
The mean of the tumour volume for each regimen is calculated using groupby. (2 points)
The media of the tumour volume for each regimen is calculated using groupby. (2 points)
The variance of the tumour volume for each regimen is calculated using groupby. (2 points)
The standard deviation of the tumour volume for each regimen is calculated using groupby. (2 points)
The SEM of the tumour volume for each regimen is calculated using groupby. (2 points)
...
An empty list is created to fill with tumour volume data. (3 points)
A for loop is used to display the interquartile range (IQR) and the outliers for each treatment group (10 points)
A box plot is generated that shows the distribution of the final tumour volume for all the mice in each treatment group. (5 points)
...
The correlation coefficient and linear regression model are calculated for mouse weight and average tumour volume for the Capomulin regimen. (10 points)
